...
internal fun SignCommonTextField(
    ...
    Column {
        OutlinedTextField(
            ...
            supportingText = if (errorMessage != null || showInputCount) {
                @Composable {
            ...
            keyboardActions = if (onNext != null) KeyboardActions(onNext = { onNext.invoke() }) else KeyboardActions.Default, // Next를 눌렀을 경우
